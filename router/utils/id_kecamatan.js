...
router.route('/id-kecamatan')
    .get(async function(req,res) {
        ...
        for (let i = 0; i < idKota.length; i++) {
            // console.log(idKota);
            await fetchKecamatan(idKota[i])
            .then(async (response) => {
                let parsedKecamatan = []
        ...
        for (let i = 0; i < idKota.length; i++) {
            ...
            .then(async (response) => {
                ...
                for (let j = 0; j < response.data.kecamatan.length; j++){
                    await parsedKecamatan.push({nama: response.data.kecamatan[j].nama, id_kota: i+1})
                }
                await tampungKecamatan.push(parsedKecamatan)    
                for(let j = 0; j < parsedKecamatan.length; j++){
                    var sql = "INSERT INTO kecamatan (nama,id_kota) VALUES ('" + parsedKecamatan[j].nama + "', '" + parsedKecamatan[j].id_kota + "')"
